        ...
        <div className="grid gap-5 lg:grid-cols-[1.1fr,0.9fr]">
          ...
          <BrutalCard tone="dark">
            ...
            <div className="mt-5 space-y-3 text-sm leading-7">
              <InfoBox title="Fee per mint" tone="dark">Shown from token config.</InfoBox>
              <InfoBox title="Paid from" tone="dark">Your linked wallet through EIP-7702 delegation.</InfoBox>
              <InfoBox title="Wallet cap" tone="dark">Mint limits are enforced per wallet.</InfoBox>
              <InfoBox title="Gas" tone="dark">The relayer handles the Claude/MCP broadcast transaction.</InfoBox>
              <InfoBox title="Important" tone="dark">CATSHIT never connects without your approval. You add the connector and approve wallet access yourself.</InfoBox>
            </div>
          </BrutalCard>
        </div>
      </div>
